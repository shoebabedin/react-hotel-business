                ...
                >
                    {
                        facilities.map(item => 
                            ...
                            <div
                            class="col-span-12 md:col-span-6 lg:col-span-3 facilities_item p-7 border hover:border-transparent rounded-lg flex justify-center flex-col items-center lg:items-baseline w-full lg:text-left cursor-pointer"
                            data-aos="fade-down"
