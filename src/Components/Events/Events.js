...
import eventsData from "../../JsonData/eventsData";
        ...
        <div className="container mx-auto px-2">
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12">
              <div className="event_part">
                {
                    eventsData.map(item => 
                        <div className="events-item max-w-7xl mx-auto flex items-start  justify-start gap-4 lg:gap-16 mb-6 flex-col lg:flex-row mb-10 lg:mb-16">
          ...
          <div className="pagination mb-[80px]">
            <ul className="flex items-center justify-end gap-4 mt-8">
              <li className="rounded-full border text-sm w-6 lg:w-11 h-6 lg:h-11 text-[#151515] flex items-center justify-center text-white">
                1
              </li>
              <li className="rounded-full border text-sm w-6 lg:w-11 h-6 lg:h-11 flex items-center justify-center text-black">
                2
              </li>
              <li className="rounded-full border text-sm w-6 lg:w-11 h-6 lg:h-11 flex items-center justify-center text-black">
                3
