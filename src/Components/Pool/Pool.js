            ...
            <div className="container mx-auto px-2">
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 lg:col-span-10 lg:mr-28">
                  <div class="flex items-start justify-between flex-col lg:flex-row mb-[26px]">
                    <h2 class="font-bold text-base lg:text-4xl text-[#151515] mb-[26px]">
                      POOL
                    </h2>
                    <p class="font-bold text-base lg:text-[32px] text-[#BE9E57]">
                      $10 <span class="">/ Per Guest</span>
                    </p>
                  </div>
